...
const DONATE_LINK = "https://www.facebook.com/gamerz.emulatorz";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>EKY EDOGAWA VPN</span>");
